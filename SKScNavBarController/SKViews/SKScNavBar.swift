...
//  SCNavController
//
//  Created by Sukun&翁承志 on 15/9/29.
...
class SKScNavBar: UIView, SKLaunchMenuDelegate {
        ...
        set{
            ...
            UIView.animateWithDuration(0.2) { () -> Void in
                ...
                for btn in self.items {
                    ...
                    tempBtn.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
                    tempBtn.titleLabel?.font = UIFont(name:"Microsoft YaHei", size:14)  //导航栏文字
                    tempBtn.titleLabel?.shadowColor=UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.2)//设置阴影颜色
                    tempBtn.titleLabel?.shadowOffset=CGSizeMake(1, 1)//设置阴影大小
                }
                itemBtn.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
                itemBtn.titleLabel?.font = UIFont(name:"Microsoft YaHei", size:16)      //点击之后导航栏文字
                itemBtn.titleLabel?.shadowColor=UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.2)//设置阴影颜色
                itemBtn.titleLabel?.shadowOffset=CGSizeMake(1, 1)//设置阴影大小
            }
        }
        get{
    ...
    private var showArrowButton:Bool = false       //显示扩展菜单按钮
    ...
    private func configView() {
        ...
        //调用给视图设置阴影的方法
        setShadowForView(self, shadowRadius: 0.0, shadowOpacity: 0.0)
    }
    ...
    private func getScNavContentAddScNavBarItemsWithItemsWidth(widths:NSArray) -> CGFloat {
        ...
        for index in 0 ..< itemsTitles.count {
            ...
            button.titleLabel?.font = UIFont(name:"Microsoft YaHei", size:14)
        ...
        btn.titleLabel?.font = UIFont(name:"Microsoft YaHei", size:16)
