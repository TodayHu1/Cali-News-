...
//  CaliTest
//
//  Created by 翁承志 on 16/4/24.
//  Copyright © 2016年 SuperCali. All rights reserved.
//

import UIKit

class ZhihuView: UITableViewController, HomeModelProtocal {
    ...
    override func viewDidLoad() {
        ...
        let nib = UINib(nibName: "ZhihuCell", bundle: nil)
        self.tableView.registerNib(nib, forCellReuseIdentifier: "ZhihuCell")      //注册自定义单元格
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("ZhihuCell", forIndexPath: indexPath) as! ZhihuCell                              //定义cell
