...
class SKScNavViewController: UIViewController, SKScNavBarDelegate, UIScrollViewDelegate {
     ...
     * 是否显示扩展按钮
     */
    var showArrowButton:Bool! = false        // 默认值是true
    /**
     * 导航栏的颜色
     */
    ...
    private func initParamConfig() {
        ...
        scNavBarColor = UIColor(red: 53/255, green: 108/255, blue: 208/255, alpha: 1)   //自定义导航栏颜色
        ...
        lineColor = UIColor(red: 250/255, green: 173/255, blue: 5/255, alpha: 1)   //下划线颜色
        //获取所有子视图控制器上的title
    ...
    private func viewParamConfig() {
        ...
        subViewControllers.enumerateObjectsUsingBlock { (_, index:Int, _) -> Void in
            ...
            vc.view.frame = CGRectMake(CGFloat(index) * kScreenWidth, 0, kScreenWidth, self.mainView.frame.size.height-63)          //生成的界面的尺寸
